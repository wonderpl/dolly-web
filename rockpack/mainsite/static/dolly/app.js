(function(w,d,n,ng,ns) {
    ...
    app.constant('RETINA', (function() {
        if (w.matchMedia) {
            var mq =    'only screen and (-moz-min-device-pixel-ratio: 1.3), ' +
    ...
    app.constant('MOBILE', (function(a) {
    ...
    app.run(['$timeout', '$rootScope', 'MOBILE', 'animLoop', function($timeout, $rootScope, MOBILE, animLoop) {
